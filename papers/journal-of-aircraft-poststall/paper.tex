...
batch-mean confidence intervals stay wider than the means. The missing
ingredient is RESOLUTION --- finer shedding with fast summation ---
not further regularization; two rejected shortcuts (a merge rule that
annihilated counter-rotating pairs, and impulse bookkeeping that hid
systematic strength edits) each produced tightly converged means that
were wrong by an order of magnitude, and are recorded as warnings
