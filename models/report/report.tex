...
\varid{aeroDCY} & $\alpha\times\delta_a$ & $\Delta C_Y$ & retained though
symmetry expects $\approx 0$ \\
\varid{aeroDCZ} & $\alpha\times\delta_a$ & $\Delta C_Z$ & \\
\varid{aeroDCl} & $\alpha\times\delta_a$ & $\Delta C_l$ & the primary
roll authority \\
\varid{aeroDCm} & $\alpha\times\delta_a$ & $\Delta C_m$ & \\
\varid{aeroDCn} & $\alpha\times\delta_a$ & $\Delta C_n$ & adverse yaw \\
\addlinespace
...
\item Inspect post-stall aileron effectiveness before shipping: the
coupled solve should attenuate roll authority past separation, and a
table that retained attached-flow authority at $\alpha = 40\dg$ would
model a simulator recovering from departures it should not.
